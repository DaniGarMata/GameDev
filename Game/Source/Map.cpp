...
bool Map::LoadProps()
{
	...
	while (mapLayerItem != NULL) {
		...
		if (mapLayerItem->data->properties.GetProperty("Mushrooms") == 1)
		{
			for (int x = 0; x < mapLayerItem->data->width; x++)
			{
				for (int y = 0; y < mapLayerItem->data->height; y++)
		...
		if (mapLayerItem->data->properties.GetProperty("Bullet") == 1)
		{
			for (int x = 0; x < mapLayerItem->data->width; x++)
			{
				for (int y = 0; y < mapLayerItem->data->height; y++)
		...
		if (mapLayerItem->data->properties.GetProperty("Goomba") == 1)
		{
			for (int x = 0; x < mapLayerItem->data->width; x++)
			{
				for (int y = 0; y < mapLayerItem->data->height; y++)
